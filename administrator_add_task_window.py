...
"background-color: qlineargradient(spread:pad, x1:0.091, y1:0.101636, x2:0.991379, y2:0.977, stop:0 rgba(209, 107, 165, 255), stop:1 rgba(255, 255, 255, 255));}")
        ...
        self.titleLineEdit.setGeometry(QRect(120, 120, 271, 41))
        font = QFont()
...
"color: rgb(0,0,0);")
        ...
        self.priorityComboBox.setGeometry(QRect(120, 340, 271, 41))
...
"color: rgb(0,0,0);")
        ...
        self.dateTimeEdit.setGeometry(QRect(120, 420, 271, 41))
...
"color: rgb(0,0,0);")
        ...
        self.categoryComboBox.setGeometry(QRect(120, 500, 271, 41))
...
"color: rgb(0,0,0);")
        ...
        self.pushButton.setGeometry(QRect(180, 580, 141, 41))
        font1 = QFont()
...
"}")
        ...
        self.descriptionTextEdit.setGeometry(QRect(120, 200, 271, 101))
...
"color: rgb(0,0,0);")
        ...
        self.label_8.setGeometry(QRect(120, 100, 81, 21))
        font2 = QFont()
...
"color: rgb(0,0,0);")
        ...
        self.userComboBox.setGeometry(QRect(120, 40, 271, 41))
        self.userComboBox.setStyleSheet(u"background-color:rgb(255, 255, 255);\n"
"border-color: rgb(0,0,0);\n"
"font: 12pt \"MS Shell Dig 2\";\n"
"color: rgb(0,0,0);")
        self.label_13 = QLabel(self.centralwidget)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(120, 20, 81, 21))
...
"color: rgb(0,0,0);")
    ...
    def retranslateUi(self, AdministratorAddTaskWindow):
        AdministratorAddTaskWindow.setWindowTitle(QCoreApplication.translate("AddTaskWindow", u"MainWindow", None))
        ...
        self.label_13.setText(QCoreApplication.translate("AddTaskWindow", u"User", None))
    # retranslateUi
    ...
    def get_task_data(self, window):
        ...
        if not title or not description:
            self.errorLabel.setText("Fulifill all the data")
        else:    
            data_manager.add_task(title, task_manager.Categories[category].value, description, task_manager.Priority[priority].value, deadline, user)
            window.close()
            self.callback()     
