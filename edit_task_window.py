...
"font: 12pt \"MS Shell Dig 2\";\n"
"color: rgb(0,0,0);")
        self.pushButton = QPushButton(self.centralwidget, clicked = lambda: self.edit_button_clicked(EditTaskWindow))
...
"color: rgb(0,0,0);")
        ...
        self.errorLabel.setObjectName(u"label")
        self.errorLabel.setGeometry(QRect(120, 490, 261, 21))
        self.errorLabel.setStyleSheet(u"font: 12pt \"MS Shell Dig 2\";  color: red;")
        EditTaskWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QStatusBar(EditTaskWindow)
        self.statusbar.setObjectName(u"statusbar")
        EditTaskWindow.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, EditTaskWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("EditTaskWindow", u"Edit", None))
        self.label_8.setText(QCoreApplication.translate("EditTaskWindow", u"Title", None))
        self.label_9.setText(QCoreApplication.translate("EditTaskWindow", u"Description", None))
        self.label_10.setText(QCoreApplication.translate("EditTaskWindow", u"Priority", None))
        self.label_11.setText(QCoreApplication.translate("EditTaskWindow", u"Deadline", None))
        self.label_12.setText(QCoreApplication.translate("EditTaskWindow", u"Category", None))
    # retranslateUi

    def fulfill_data(self):
        self.titleLineEdit.setText(self.title)
        self.descriptionTextEdit.setPlainText(self.description)
        self.fulfill_comboboxes()
        self.categoryComboBox.setCurrentText(self.category)
        self.priorityComboBox.setCurrentText(self.priority)
        print(self.deadline)
        self.dateTimeEdit.setDateTime(QDateTime.fromString(self.deadline, "yyyy-MM-dd HH:mm:ss"))
    ...
    def edit_button_clicked(self, window):
        ...
        if not title or not description:
            self.errorLabel.setText("Fulfill all the data")
                ...
                data_manager.update_task(self.id, title, task_manager.Categories[category].value, description, task_manager.Priority[priority].value, deadline, self.login)
                self.callback()
                window.close()    