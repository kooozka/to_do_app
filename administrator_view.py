...
class Ui_AdministratorMainWindow(object):
    ...
    def setupUi(self, AdministratorMainWindow):
        ...
        AdministratorMainWindow.resize(990, 711)
        AdministratorMainWindow.setStyleSheet(u"")
        self.centralwidget = QWidget(AdministratorMainWindow)
...
"}")
        ...
        center(AdministratorMainWindow)
        self.get_tasks()
        self.listView.clicked.connect(self.fulfill_task_data)
        self.comboBox.currentIndexChanged.connect(self.get_tasks)

        QMetaObject.connectSlotsByName(AdministratorMainWindow)
    # setupUi

    def retranslateUi(self, AdministratorMainWindow):
        AdministratorMainWindow.setWindowTitle(QCoreApplication.translate("AdministratorMainWindow", u"MainWindow", None))
        self.previousButton.setText(QCoreApplication.translate("AdministratorMainWindow", u"Previous", None))
        self.nextButton.setText(QCoreApplication.translate("AdministratorMainWindow", u"Next", None))
        self.label.setText(QCoreApplication.translate("AdministratorMainWindow", u"ToDo App", None))
        self.comboBox.setItemText(0, QCoreApplication.translate("AdministratorMainWindow", u"Deadline", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("AdministratorMainWindow", u"Priority", None))

        self.label_2.setText(QCoreApplication.translate("AdministratorMainWindow", u"Sort by:", None))
        self.addButton.setText(QCoreApplication.translate("AdministratorMainWindow", u"\u271a", None))
        self.removeButton.setText(QCoreApplication.translate("AdministratorMainWindow", u"\u2718", None))
        self.editPushButton.setText(QCoreApplication.translate("AdministratorMainWindow", u"\u270e", None))
        self.label_8.setText(QCoreApplication.translate("AdministratorMainWindow", u"Title", None))
        self.label_9.setText(QCoreApplication.translate("AdministratorMainWindow", u"Description", None))
        self.label_10.setText(QCoreApplication.translate("AdministratorMainWindow", u"Priority", None))
    ...
    def add_button_clicked(self):
        ...
        self.ui = Ui_AdministratorAddTaskWindow(self.get_tasks)
